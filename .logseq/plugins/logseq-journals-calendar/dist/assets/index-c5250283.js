...
function trigger(target, type, key, newValue, oldValue, oldTarget) {
    ...
    if (type === "clear" /* TriggerOpTypes.CLEAR */) {
        ...
        const newLength = toNumber$3(newValue);
...
function ownKeys(target) {
    track(target, "iterate" /* TrackOpTypes.ITERATE */, isArray$f(target) ? 'length' : ITERATE_KEY);
...
function traverse(value, seen) {
    if (!isObject$e(value) || value["__v_skip" /* ReactiveFlags.SKIP */]) {
        return value;
    }
    seen = seen || new Set();
    if (seen.has(value)) {
        ...
        for (const key in raw) {
            ...
            if (validatePropName(normalizedKey)) {
                ...
                const prop = (normalized[normalizedKey] =
                    isArray$f(opt) || isFunction$4(opt) ? { type: opt } : Object.assign({}, opt));
                if (prop) {
...
const App = /*#__PURE__*/_export_sfc$1(_sfc_main$b, [['render',_sfc_render$6]]);
